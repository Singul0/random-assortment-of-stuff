...
int main(){
    ...
    std::cout << ("Masukan gravitasi bumi:"); //bisa pake constants, tapi biarkan user mau gravitasi seberapa (10m/s, 9.8m/s, 9.81 terserah)
    std::cin >> gravitasi;
...
/* kalkulasi_burung_boro
*   Fungsi rekursif yang akan diulang ulang hingga semua burung yang telah diproses
*/
